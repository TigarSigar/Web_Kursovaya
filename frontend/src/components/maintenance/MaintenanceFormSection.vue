...
<template>
  <div class="grid gap-4 md:grid-cols-2">
    <label class="field-group md:col-span-2">
      ...
      <select
        class="input-base"
        :value="modelValue.carId"
        @change="update('carId', ($event.target as HTMLSelectElement).value)"
      >
    ...
    <label class="field-group">
      ...
      <input
        class="input-base"
        :value="modelValue.serviceType"
        @input="update('serviceType', ($event.target as HTMLInputElement).value)"
      />
    </label>
    <label class="field-group">
      ...
      <select
        ...
        @change="update('status', ($event.target as HTMLSelectElement).value as MaintenanceFormModel['status'])"
      >
