...
export const useAuthStore = defineStore('auth', {
  ...
  actions: {
    ...
    async updateClientProfile(payload: { driverLicenseNumber?: string; phone?: string; avatarBase64?: string }) {
      ...
      try {
        const fullPayload = {
          ...
          avatarBase64: payload.avatarBase64 ?? this.currentClientProfile.avatarBase64
        }
