      ...
      <div class="public-home__container">
        ...
        <div class="public-home__steps">
          <article class="card-base public-home__step">
            <div class="public-home__step-header">
              <div class="public-home__step-icon">
                <MapPin class="h-6 w-6 text-primary" />
              </div>
              <span class="public-home__step-number">01</span>
            </div>
            <h3 class="public-home__step-title">{{ copy.howLocationTitle }}</h3>
            <p class="public-home__step-description">{{ copy.howLocationText }}</p>
          </article>
          <article class="card-base public-home__step">
            <div class="public-home__step-header">
              <div class="public-home__step-icon">
                <CalendarCheck2 class="h-6 w-6 text-primary" />
              </div>
              <span class="public-home__step-number">02</span>
            </div>
            <h3 class="public-home__step-title">{{ copy.howDatesTitle }}</h3>
            <p class="public-home__step-description">{{ copy.howDatesText }}</p>
          </article>
          <article class="card-base public-home__step">
            <div class="public-home__step-header">
              <div class="public-home__step-icon">
            ...
            <h3 class="public-home__step-title">{{ copy.howCarTitle }}</h3>
            <p class="public-home__step-description">{{ copy.howCarText }}</p>
          </article>
          <article class="card-base public-home__step">
            <div class="public-home__step-header">
              <div class="public-home__step-icon">
            ...
            <h3 class="public-home__step-title">{{ copy.howDriveTitle }}</h3>
            <p class="public-home__step-description">{{ copy.howDriveText }}</p>
          </article>
        </div>
      </div>
    </section>
    ...
    <section class="public-home__section public-home__section--cta">
      <div class="public-home__container public-home__cta-grid">
        <article class="glass-panel public-home__cta-card">
          <div class="public-home__cta-card-body">
