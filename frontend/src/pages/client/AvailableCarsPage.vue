...
<template>
  <section class="available-cars-page layout-container py-8 lg:py-10">
    ...
    <div class="mt-6">
      ...
      <template v-else-if="!searchParams.from || !searchParams.to">
        <EmptyState :title="copy.selectPeriod" :description="copy.selectPeriodText">
      ...
      <template v-else>
        <section class="available-cars-page__section">
          ...
          <div v-if="available.length" class="grid gap-4 xl:grid-cols-2">
            <CarCard
          ...
          <EmptyState v-else :title="copy.noCars" :description="copy.noCarsText">
            <template #icon><CarFront class="h-8 w-8" /></template>
          </EmptyState>
        </section>

        <section class="available-cars-page__section mt-8">
          <div class="available-cars-page__section-header">
          ...
          <div v-if="unavailable.length" class="grid gap-4 xl:grid-cols-2">
