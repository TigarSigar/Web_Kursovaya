...
const copy = computed(() =>
  locale.value === 'ru'
    ...
    : {
        ...
        subtitle: 'Validation prevents maintenance from overlapping with an existing rental period for the same vehicle.',
  ...
  <section>
    ...
    <div v-else class="card-base p-6">
      ...
      <div class="mt-6 flex gap-3">
        <button class="btn-secondary" type="button" @click="router.push('/manager/maintenance')">{{ locale === 'ru' ? 'Назад' : 'Back' }}</button>
