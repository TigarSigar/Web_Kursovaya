...
const messages: Record<AppLocale, Record<string, string>> = {
  en: {
    ...
    'auth.heroSubtitle':
      'Sign in to manage reservations, process vehicle handovers and keep fleet availability under control.',
    ...
    'errors.403Text':
      'This page is intended for another role. Client and manager areas are separated by route permissions.',
  ...
  ru: {
    ...
    'auth.registerSubtitle':
      'Начните с клиентского аккаунта и получите доступ к бронированию, арендам и отслеживанию статусов.',
    ...
    'errors.403Text':
      'Эта страница предназначена для другой роли. Клиентская и менеджерская зоны разделены правами доступа.',
