...
class CarServiceImpl(
    ...
    override fun findAll(): List<CarResponse> = carRepository.findAll().map { it.toFrontendResponse() }

    @Transactional(readOnly = true)
    override fun findById(id: Long): CarResponse = findEntity(id).toFrontendResponse()
