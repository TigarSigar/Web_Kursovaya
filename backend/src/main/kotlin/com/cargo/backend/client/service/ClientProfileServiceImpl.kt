...
class ClientProfileServiceImpl(
    ...
    override fun findAll(): List<ClientResponse> = clientProfileRepository.findAll().map { it.toFrontendResponse() }

    @Transactional(readOnly = true)
    override fun findById(id: Long): ClientResponse = findEntity(id).toFrontendResponse()
