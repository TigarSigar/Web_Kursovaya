...
class MaintenanceWindowServiceImpl(
    ...
    override fun findAll(): List<MaintenanceWindowResponse> = maintenanceWindowRepository.findAll().map { it.toResponse() }

    @Transactional(readOnly = true)
    override fun findById(id: Long): MaintenanceWindowResponse = findEntity(id).toResponse()
    ...
    private fun validateOverlapForCreate(
        carId: Long,
        startDate: java.time.LocalDate,
        endDate: java.time.LocalDate,
    ) {
    ...
    private fun validateOverlapForUpdate(
        id: Long,
        carId: Long,
        startDate: java.time.LocalDate,
        endDate: java.time.LocalDate,
    ...
    private fun MaintenanceWindow.toResponse() =
        MaintenanceWindowResponse(
